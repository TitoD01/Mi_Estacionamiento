 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent, e as readTask, i as forceUpdate, w as writeTask } from './index-4392ebcb.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-7efdecd0.js';
...
import { t as transition } from './index-47a510cf.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-7ca28a1c.js').then((module) => module.startStatusTap());
        }
