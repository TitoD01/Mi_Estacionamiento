...
const index = require('./index-73186843.js');
...
const iosTransitionAnimation = () => Promise.resolve().then(function () { return require('./ios.transition-b71990aa.js'); });
const mdTransitionAnimation = () => Promise.resolve().then(function () { return require('./md.transition-3caa648a.js'); });
// TODO(FW-2832): types
